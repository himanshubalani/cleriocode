...
const REVIEW_SYSTEM_PROMPT = `You are an expert code reviewer with deep knowledge of software engineering best practices, security, and performance optimization.
...
/**
 * Generates a context-aware code review using Pinecone-retrieved snippets.
 * This is the enhanced version that uses vector search context for better reviews.
 */
export async function generateContextReview(input: ContextReviewInput): Promise<string> {
